...
import videoGif from "@/assets/images/extension/pocket-prompt-demo-video.gif";
...
const PocketPromptPage = () => {
  return (
    <PageContainer>
      <article id="23f9b19e-a2cb-4488-a28a-22a0fa8599de" className="page sans">
        <header>
        ...
        <div className="page-body">
          ...
          >
            <div id="ce50ff17-bf01-44e0-b7ca-62607820fb04" className="column">
              <h3 id="6aad71f9-6471-462b-b14e-9a77c8dded05" className="">
              ...
              <p id="564919db-8772-472b-a577-acadf19b9339" className=""></p>
            </div>
            <div id="b0215247-4668-4414-b07e-332b8b08eb07" className="column">
              <h3 id="98d48186-7dfd-455a-86a2-116053a0b58a" className="">
                언제 어디서나 포켓 프롬프트와 함께
              </h3>
              <ul
              ...
              <p id="019bab39-517f-49b0-8f06-0097bfa2840b" className=""></p>
            </div>
            <div id="32546173-e1e5-4d4e-927d-2bc7becc4966" className="column">
              <h3 id="228732b2-e862-42d4-9c8b-09c96658b661" className="">
                1분 1초가 소중하잖아요?
              </h3>
              <ul
              ...
              >
                <li style={{ listStyleType: "disc" }}>
                  클릭 한 번으로 나만의 프롬프트를 쉽고 빠르게, 꺼내 쓰세요
                </li>
              </ul>
              <p id="66bfec32-ca75-4443-97bc-92c0b042d865" className=""></p>
            </div>
          </div>
          ...
          >
            <li style={{ listStyleType: "disc" }}>
              무료로 크롬 익스텐션을 다운로드하고 당신의 챗GPT에 날개를
              달아주세요
            </li>
          </ul>
          <p id="9d2f6a78-caa3-410c-9ffa-63a7e999e276" className=""></p>
          <figure id="d3a293e1-d7bc-4a36-a87f-2160ee1a528c" className="image">
            <a href={videoGif}>
              <img style={{ width: "708px" }} src={videoGif} />
            </a>
          </figure>
          <p id="0df98ec2-e69d-4b11-926b-624c185fde06" className=""></p>
          <p id="d209f2d7-ec7d-4c97-abba-9f24541a7391" className=""></p>
          <h3 id="4b63dbe4-111a-4e7c-9b8a-3630ff1a5d50" className="">
            자주 묻는 질문
          </h3>
          <ul id="a4c873a2-ad1e-4617-8f76-fe4b67348364" className="toggle">
            <li>
              <details>
                ...
                >
                  <li style={{ listStyleType: "disc" }}>
                    포켓 프롬프트는 어떤 AI 서비스를 이용하더라도 함께 사용할 수
                    있는
                    <strong>크롬 익스텐션</strong>으로 현재 아래 3개 플랫폼에서
                    쉽게 사용 가능합니다.
                    <ul
          ...
          <ul id="a31a4251-ae24-43ef-96d0-5bce153235ee" className="toggle">
            <li>
              <details>
                <summary>왜 크롬 웹스토어에 검색해도 안나오나요?</summary>
                <p id="2b9744e9-d3f0-4f17-bcbc-8bb6ba3407cb" className="">
                  현재는 런칭을 준비하고 있는 Beta 단계입니다. 8월 중순에 공개
                  익스텐션으로 전환 예정이고, 현재는 링크를 통해서만 접속이
                  가능합니다.
                </p>
              </details>
            </li>
          </ul>
          <ul id="8c3e6688-8fc5-46e7-86f7-2c4bd10a8c81" className="toggle">
            <li>
              <details>
                <summary>다른 사용자들과 프롬프트를 공유할 수 있나요?</summary>
                <ul
                  id="4dd17878-4efd-4bc4-bd5f-241c65f4145f"
                  className="bulleted-list"
                >
                  <li style={{ listStyleType: "disc" }}>
                    네, 포켓 프롬프트는 사용자들 간의 프롬프트 공유를 지원하고
                    있습니다. 이를 통해 고품질의 한국어 프롬프트 플랫폼으로
                    발전해 나갈 것입니다.
                  </li>
                </ul>
              </details>
          ...
          <ul id="e4cc277a-49ec-4d80-b255-ff48f641cb46" className="toggle">
            <li>
              <details>
                <summary>포켓 프롬프트를 사용하면 어떤 이점이 있나요?</summary>
                <ul
                  id="395970ed-149e-45ba-bcc5-68416f13e495"
                  className="bulleted-list"
                >
                  <li style={{ listStyleType: "disc" }}>
                    시간 절약, 높은 품질의 프롬프트 사용, 프롬프트 작성 스킬
                    향상 등 다양한 이점이 있습니다. AI와의 상호작용을 더욱
                    효율적이고 생산적으로 만들어 줍니다.
                  </li>
                </ul>
              </details>
          ...
          <ul id="1182b42b-f54c-45d9-a476-85c4e4be6ec5" className="toggle">
            <li>
              <details>
                ...
                >
                  <li style={{ listStyleType: "disc" }}>
                    완벽한 프롬프트란 없습니다. 여러분의 필요에 맞는 프롬프트를
                    만드는 것이 중요해요. 포켓 프롬프트와 함께 한 단계씩 AI를
                    마스터해나가요 😉
                  </li>
                </ul>
              </details>
          ...
          <ul id="daf31ae2-477f-47a5-9d9e-6cf40c09df6a" className="toggle">
            <li>
              <details>
                ...
                >
                  <li style={{ listStyleType: "disc" }}>
                    현재는 크롬 익스텐션으로 개발 중이므로 구글 크롬에서 사용
                    가능합니다. 향후 파이어폭스, 사파리 등 다른 주요
                ...
                >
                  <li style={{ listStyleType: "disc" }}>
                    장기적으로는 고퀄리티의 프롬프트와 결과물을 서로 공유할 수
                    있는 거대한 웹플랫폼으로의 도약을 준비 중입니다.
                  </li>
                </ul>
              </details>
            </li>
          </ul>
          <ul id="237ba05e-7627-4c09-aa0d-691a5cdf916b" className="toggle">
            <li>
              <details>
                ...
                >
                  <li style={{ listStyleType: "disc" }}>
                    포켓 프롬프트는 크롬 브라우저를 사용하시는 모든 분들이
                    무료로 다운로드 받을 수 있습니다. 또한 플러그인의 기본적인
                    기능은 모두 무료로 제공합니다. 다만 서버 및 데이터베이스
                    상황이 제한적이라서 private 프롬프트와 즐겨찾기의 수는
                    제한을 두고 있습니다. 추후 추가적인 기능에 대해 유료 플랜이
                    있을 수 있습니다.
                  </li>
                </ul>
              </details>
          ...
          <ul id="4fbd5381-c2b3-455a-9ce6-579b57e31cbe" className="toggle">
            <li>
              <details>
                <summary>프롬프트 템플릿을 수정할 수 있나요?</summary>
                <ul
                  id="44ece39d-df51-45b8-a9e2-5215725fc217"
                  className="bulleted-list"
                >
                  <li style={{ listStyleType: "disc" }}>
                    네, 저장된 프롬프트 템플릿을 언제든지 수정하고
                    커스터마이즈할 수 있습니다. 사용자의 필요에 맞게 템플릿을
                    지속적으로 개선할 수 있습니다.
                  </li>
                </ul>
              </details>
          ...
          <p id="602637ff-7231-485b-a452-268d46998377" className=""></p>
          <p id="e3c7884f-9a93-49b7-b41b-4d41d502a73c" className=""></p>
          <figure
          ...
          >
            <a href="https://www.notion.so/Pocket-Prompt-c699c0fdcf4441b6a43622e3b196b4e3?pvs=21">
              <span className="icon">📓</span>포켓 프롬프트(Pocket Prompt) 사용
              가이드
            </a>
          </figure>
          <figure
          ...
          >
            <a href="https://www.notion.so/da477857a0cc44888b06dd23cf6682ff?pvs=21">
              <span className="icon">💁‍♂️</span>프롬프트 추가하기 가이드
            </a>
          </figure>
          <figure
          ...
          >
            <a href="https://www.notion.so/Release-Note-fffd02185fca8083bad2ea2cbf1c3420?pvs=21">
              <span className="icon">🗨️</span>업데이트 Release Note
            </a>
          </figure>
          <div
          ...
          >
            <div
              ...
              className="column"
            >
              <p id="434a988d-4940-4e98-a8aa-b2021625c6bb" className=""></p>
            </div>
            <div
              ...
              className="column"
            >
              <h1 id="f2081b02-7fc2-49f5-b76b-0b362cdeb915" className="">
                <a href="https://chromewebstore.google.com/detail/pocker-prompt/ffinlaeadcgbhecidamekinhbfkdhodd?authuser=2&amp;hl=en">
            ...
            <div
              ...
              className="column"
            >
              <p id="53a67263-d2b7-4bb8-9abf-d58cc6d675e0" className=""></p>
            </div>
          </div>
          <p id="e3e6fe51-72c3-4966-9c02-c5c2cfb63fed" className=""></p>
        </div>
      </article>
      <span
        className="sans"
