                ...
                >
                    <header>
                        ...
                        <h1 className="page-title">
                            포켓 프롬프트(Pocket Prompt)
                        </h1>
                        <p className="page-description"></p>
                    </header>
                    <div className="page-body">
                        <p
                            id="e89dfd2e-1479-44a1-8fa5-cba88dfc6aa1"
                            className=""
                        >
                            당신의 AI에 날개를 달아줄 최고의 프롬프트와 함께
                        </p>
                        <p
                            id="a3a34be5-c68a-4b5d-b2ac-176b7e8cbeeb"
                            className=""
                        >
                        ...
                        <h3
                            id="8f2de4bf-4867-4b36-8eb4-3411566a63d6"
                            className=""
                        >
                            지금 바로 시작하세요!
                        </h3>
                        ...
                        ></p>
                        <h3
                            id="4b63dbe4-111a-4e7c-9b8a-3630ff1a5d50"
                            className=""
                        >
                            자주 묻는 질문
                        </h3>
                                ...
                                <details>
                                    ...
                                    >
                                        <li style={{ listStyleType: "disc" }}>
                                            포켓 프롬프트는 어떤 AI 서비스를
                                            이용하더라도 함께 사용할 수 있는
                                            <strong>크롬 익스텐션</strong>으로
                                            현재 아래 3개 플랫폼에서 쉽게 사용
                                            가능합니다.
                                            <ul
                            ...
                            <li>
                                <details>
                                    ...
                                    <p
                                        ...
                                        className=""
                                    >
                                        현재는 런칭을 준비하고 있는 Beta
                                        단계입니다. 8월 중순에 공개 익스텐션으로
                                        전환 예정이고, 현재는 링크를 통해서만
                                        접속이 가능합니다.
                                    </p>
                                </details>
                            </li>
                        ...
                        >
                            <a href="https://www.notion.so/Pocket-Prompt-c699c0fdcf4441b6a43622e3b196b4e3?pvs=21">
                                <span className="icon">📓</span>포켓
                                프롬프트(Pocket Prompt) 사용 가이드
                            </a>
                        </figure>
                        <figure
                        ...
                        >
                            <a href="https://www.notion.so/da477857a0cc44888b06dd23cf6682ff?pvs=21">
                                <span className="icon">💁‍♂️</span>프롬프트
                                추가하기 가이드
                            </a>
                        </figure>
                        <figure
